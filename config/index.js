module.exports = {
  service: {
    ...
    about: 'Quill is built with <i class="heart icon"></i><em>love</em> by <a href="https://maki.io/people">a diverse community of makers</a> from all around the world.  We\'re designing an all-new way to publish things on the web.  <a class="ui mini primary unpadded button" href="https://maki.io/topics/quill">Learn More &raquo;</a>',
